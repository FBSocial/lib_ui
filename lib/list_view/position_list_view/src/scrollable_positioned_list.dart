...
// ignore_for_file: unnecessary_null_comparison, prefer_final_locals, prefer_conditional_assignment
...
class _ScrollablePositionedListState extends State<ScrollablePositionedList>
  ...
  void _jumpTo(
      {required int index, required double alignment, double offset = 0}) {
  ...
  Future<void> _startScroll({
    ...
    if (itemPosition != null) {
      ...
      setState(() {
        // _startScroll can be re-entrant, which invalidates this assert.
